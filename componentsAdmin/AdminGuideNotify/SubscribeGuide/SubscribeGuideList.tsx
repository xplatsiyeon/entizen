...
import SubscribeGuideEidtor, { GuideUpdate } from './SubscribeGuideEidtor';
...
const SubscribeGuideList = ({ setNowHeight, setNumber }: Props) => {
...
export default SubscribeGuideList;
