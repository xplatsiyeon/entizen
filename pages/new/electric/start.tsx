  ...
  return (
    <div id="electric">
      ...
      <section className={styles.sec_02}>
        ...
        >
          ...
          <div className={styles.text_02}>
            너도 나도 뛰어드는 창업시장, 남들이 다 알고 있는 시장이라면 이미
            늦었습니다.
          </div>
          <div className={styles.item_wrapper}>
            <div className={styles.item}>
              “출근걱정 없어요”...직장 다니며 차린 카페, 월 1000만원 매출
            </div>
            <div className={styles.item}>
              요즘 아파트에 무인 아이스크림 가게 생겨나는 이유는?
            </div>
      ...
      <section className={styles.sec_05}>
        <div className={styles.item_wrapper}>
          ...
          <div className={styles.text_wrapper}>
            ...
            <div className={styles.text_02}>
              LS ELECTRIC의 전기차 충전기 플랫폼 ‘엔티즌’은
              <br />
              개인과 전기차 충전기 설치 업체를 연결시켜주는 플랫폼입니다.
            </div>
          </div>
        </div>
      </section>
      ...
      <section className={styles.sec_06}>
        <div
          className={classNames(styles.container, styles.how_start_container)}
        >
          <div className={styles.title}>
            전기차 충전기 사업 어떻게 시작하나요?
          </div>
          {isMobile ? (
            <div className={styles.step_mb}>
              <Image src={stepMb} alt="step_mb" layout="responsive" />
            </div>
          ) : (
            <div className={styles.item_wrapper}>
              <div className={styles.item}>
