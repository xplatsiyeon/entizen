        ...
        <div className={styles.banner_container}>
          ...
          <div className={styles.title_container}>
            ...
            <div className={styles.text_02}>
              ...
              <div className={styles.right}>
                <span className={styles.textTop}>
                  <span className={styles.textColorPrice}>110~230</span>
                  만원
                </span>
            ...
            <div className={styles.text_03}>
              <span>
                가성비 업체부터 충전 시스템이 뛰어난 업체까지 다양한 파트너와
                함께 합니다.
              </span>
              <span>
                맞춤 견적을 받으시면 가격뿐만 아니라 A/S현황, 시공횟수 등 다양한
                비교 요소를 확인하실 수 있습니다.
              </span>
            </div>
          </div>
        ...
        <div className={styles.container}>
          <div className={styles.comparison_wrapper}>
            <div className={styles.comparison_container}>
              ...
              <div className={styles.text_02}>
                제조사 37곳 운영사 112곳 직접 비교하시면 너무 복잡해요!
                <br />
                엔티즌이 우수한 업체들만 모아, 한눈에 비교하실 수 있게
                정리해드려요!
              </div>
              <Stack
                className={styles.comparison_box}
                direction="row"
                spacing={2}
              >
                <div className={styles.price_container}>
                  ...
                  <Button
                    className={styles.show_estimate_btn}
                    variant="contained"
                    disabled
                  >
                    견적서 보기
                ...
                <div className={styles.price_container}>
                  ...
                  <Button
                    ...
                    disabled
                  >
                    <Image src={Kakao} className={styles.kakaoIcon} />
                    <p>채팅하기</p>
                  </Button>
                  <Button
                    className={styles.show_estimate_btn}
              ...
              <div className={styles.text_03}>
                모든 <span>견적비교</span>가 궁금하시다면?
              </div>
            </div>
            <Button
              className={styles.more_btn}
              variant="contained"
              onClick={clickGetMoreEstimate}
            >
              더 많은 업체 견적 받기 <NavigateNextIcon />
            </Button>
          </div>
        </div>
      </div>
