...
const Signin = () => {
  ...
  // const NAVER_CLIENT_ID = process.env.NEXT_PUBLIC_NAVER_LOGIN_CLIENT_ID; // 발급 받은 Client ID 입력
  // const NAVER_CALLBACK_URL = 'http://localhost:3000/signUp/Terms'; // 작성했던 Callback URL 입력
