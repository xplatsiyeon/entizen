    ...
    <div className={styles.func_system_comparison_page}>
      ...
      <section className={styles.sec_02}>
        ...
        <article className={styles.info_wrap}>
          {isMobile ? (
            ...
            >
               <SwiperSlide>
                 <div className={styles.info_img}><Image src={Image1Mb} alt=''/></div>
               </SwiperSlide>
               <SwiperSlide>
                <div className={styles.info_img}><Image src={Image2Mb} alt=''/></div>
               </SwiperSlide>
               <SwiperSlide>
                <div className={styles.info_img}><Image src={Image3Mb} alt=''/></div>
               </SwiperSlide>
             </Swiper>
           </div>
          ) : (
           ...
           >
             <Grid item xs={4} className={styles.info_item}>
               <div className={styles.info_img}><Image src={Image1} alt=''/></div>
             </Grid>
             <Grid item xs={4} className={styles.info_item}>
               <div className={styles.info_img}><Image src={Image2} alt=''/></div>
             </Grid>
             <Grid item xs={4} className={styles.info_item}>
               <div className={styles.info_img}><Image src={Image3} alt=''/></div>
             </Grid>
           </Grid>
          )}
        </article>
      ...
      <section className={styles.sec_03}>
        ...
        <div className={styles.item_container}>
          {sec_03_contents.map((content, index) => (
            <div className={styles.item_wrapper} key={index}>
              ...
              <div className={styles.item_02}><Image src={content.icon} alt=''/></div>
            </div>
          ))}
        </div>
      </section>
